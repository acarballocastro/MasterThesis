...
from CGProtoPNet.utils.receptive_field import compute_rf_prototype
from CGProtoPNet.utils.helpers import makedir, find_high_activation_crop
...
def update_prototypes_on_batch(search_batch_input,
    ...
    for j in progress_bar(range(n_prototypes), total=n_prototypes, leave=False):
