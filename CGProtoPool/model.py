...
from CGProtoPool.utils.resnet_features import resnet18_features, resnet34_features, resnet50_features, resnet101_features, resnet152_features
from CGProtoPool.utils.densenet_features import densenet121_features, densenet161_features, densenet169_features, densenet201_features
from CGProtoPool.utils.vgg_features import vgg11_features, vgg11_bn_features, vgg13_features, vgg13_bn_features, vgg16_features, vgg16_bn_features,\
                         vgg19_features, vgg19_bn_features
import numpy as np

from CGProtoPool.utils.utils import compute_proto_layer_rf_info_v2
...
class PrototypeChooser(nn.Module):
    def __init__(self, num_prototypes: int, num_descriptive: int, num_classes: int,
        ...
        self.proto_presence = torch.zeros(num_classes*2, num_prototypes, num_descriptive)  # [2c, p, K]
